...
<head>
    ...
    <title>Title</title>
    <link type="text/css" rel="stylesheet" href="regiistration.css">
    ...
    <nav class="navbar navbar-inverse offset-3 pull right" style="border-radius: 0px!important;">
        <div class="container-fluid" style="background-color: black;">
            <div class="navbar-header" style="padding-right: 30px;">
                ...
                <a class="navbar-brand" style="padding-top: 0px;" href="MCmainpage.php"><img alt="Brand" src="Безымянный.png"></a>
            </div>
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="margin-left: 15px">
                ...
                <ul class="nav navbar-nav navbar-left">
                    <li class="dropdown disabled">
                        <a id="ops" style="color:white;" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">SEARCH</a>
                        <ul class="dropdown-menu" style="border-top:2px solid lime;">
                            <li style="width: 200px"><input type="text" class="form-control"  style="margin-left: 5px;width: 150px;float: left;" placeholder="Search for...">
                        <span class="input-group-btn" style="width: 100px">
                            <button class="btn btn-default" type="button" style="float: left"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
                        </span></li>
                        </ul>
                    </li>
                </ul>
                ...
                <?php }
                    ...
                    echo '<a id="ops" style="color:white;" href="#" data-toggle="modal" data-target=".bs-example-modal-sm"  role="button" aria-haspopup="true" aria-expanded="false">LOGIN<span class="glyphicon glyphicon-log-in" aria-hidden="true" style="padding-left: 5px"></span></a>
                                    <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
                                        ...
                                        <input type="text" id="login" style="width:100%;border:1px solid yellow;" class="form-control"  placeholder="Your login here" name="login" aria-describedby="sizing-addon2">
                                        <label for="password" id="pas_label">Password:</label>
                                        <input type="password" id="password" style="width:100%;border:1px solid yellow;" name="password" class="form-control"  placeholder="Your password here" aria-describedby="sizing-addon2">
